  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="mt-8 space-y-5 leading-7 text-zinc-300">
        <p>FileFlux processes files in isolated containers and never writes uploads to permanent storage.</p>
        ...
        <p>AdSense may set cookies for advertising. FileFlux does not sell personal data to third parties.</p>
      </div>
    </main>
  );
}
